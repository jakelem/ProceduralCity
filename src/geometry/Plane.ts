...
class Plane extends Mesh {
  ...
  loadMesh() {
    ...
    let p1 = vec4.fromValues(0.5,0,0.5,1);
    pos.push(p1);

    let u1 = vec2.fromValues(1.0,1.0);
    uvs.push(u1);

    let p2 = vec4.fromValues(0.5, 0, -0.5,1);
    pos.push(p2);

    let u2 = vec2.fromValues(0.0,1.0);
    uvs.push(u2);

    let p3 = vec4.fromValues(-0.5,0, -0.5,1);
    pos.push(p3);

    let u3 = vec2.fromValues(0.0,0.0);
    uvs.push(u3);

    let p4 = vec4.fromValues(-0.5,0, 0.5,1);
    pos.push(p4);

    let u4 = vec2.fromValues(1.0,0.0);
    uvs.push(u4);
